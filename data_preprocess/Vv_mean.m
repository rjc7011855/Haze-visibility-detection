...
eval(strcat(road_point,'_',tester_name,'_mean','=n;'));
save_address_name=strcat('.\mean\',road_point,'\',road_point,'_',tester_name,'_mean','.mat');
save(save_address_name,strcat(road_point,'_',tester_name,'_mean')) 