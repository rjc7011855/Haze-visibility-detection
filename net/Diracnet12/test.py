...
with tf.Session() as sess:
    ...
    saver = tf.train.import_meta_graph('./1.24dirac_model/1.24model.ckpt.meta')
    saver.restore(sess, tf.train.latest_checkpoint('./1.24dirac_model/'))
    ...
    print(mape)
    #plt.plot(mape)
    #plt.title('diracnet_average_mape:'+ str(testLoss))
    #plt.savefig('./diracnet_mape.png')