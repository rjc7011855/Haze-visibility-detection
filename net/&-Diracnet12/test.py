...
with tf.Session() as sess:
    ...
    saver = tf.train.import_meta_graph('./new_dirac_model/model.ckpt.meta')
    saver.restore(sess, tf.train.latest_checkpoint('./new_dirac_model/'))
